        ...
        process.nextTick(function() {
            ...
            User.findOne({ 'facebook.id' : profile.id }, function(err, user) {
                ...
                if (user) {
                    ...
                    var possibleUsername = profile.username || ((newUser.facebook.email) ? newUser.facebook.email.split('@')[0] : '');
                    newUser.facebook.username = possibleUsername;
                    ...
                    newUser.save(function(err) {
                        ...
                        console.log('db save successfully: ' + newUser);
                        return done(null, newUser);
                    });
                }
